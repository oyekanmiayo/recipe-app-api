...
class PrivateTagsAPITests(TestCase):
    ...
    def test_retrieve_tags_is_successful(self):
        """Test retrieve tags"""
    ...
    def test_create_tag_with_invalid_details_invalid(self):
        """Test that tag is not created when name is empty"""
